...
$(document).ready(function () {$('body').append('<div id="chat_div"></div><div id="log"></div><!-- Chat Head --><a id="chat-head" href="#"><i>1</i></a>');
   ...
   reg = typeof reg !== 'undefined' ? reg : /\, |\. /g; // list of words to omit, if you use weights do not set score for that word
     ...
     nameagent = typeof nameagent !== 'undefined' ? nameagent : "AI Assistant"; // Name of bot
     var check = null;   
...
(function($) {
    $.widget("ui.chatbox", {
            ...
            boxManager: {
                ...
                addMsg: function(peer, msg) { // peer es el nombre del que hablar
                    ...
                    if (peer) {
                       ...
                       elem.setAttribute("src", "AIchat/images/vchat40g.png");
      ...
      else{  uiChatboxRest = (self.uiChatboxRest = $('<div><ul>	<li>		<a href="#">Related Answers</a>	<ul id="respuestarel">		</ul>		</li>		<li>Answer not found? please drop a message at "CONTACT INFO" section of this page.</li></ul></div>'))
                .addClass('ui-widget-content ' +
                          'ui-chatbox-rest ' 
                         )
                .appendTo(uiChatboxContent);}
